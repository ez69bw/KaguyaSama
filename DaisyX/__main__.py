...
PM_START_TEXT = """
Haii, Saya [𝙚𝙯𝙗𝙬!](https://telegra.ph/file/197f72f40d7579fa98a91.jpg)

Saya adalah bot mengatur grup untuk meramaikan grup anda.
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="Add 𝙚𝙯𝙗𝙬 to your group", url="t.me/daisyXBot?startgroup=true"
        ),
    ],
]
...
HELP_STRINGS = f"""
*Main Commands :* [🤖](https://telegra.ph/file/197f72f40d7579fa98a91.jpg)
...
def DaisyX_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"*Hi again!  The name's {dispatcher.bot.first_name} \n\nAs  You I'm a next generational group management bot developed by paris.* "
            f"\n\n Jangan lupa join [INTENSE FEELINGS](https://t.me/feelingsonlyz)"
