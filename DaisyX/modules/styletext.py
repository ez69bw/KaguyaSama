...
def medi(update, context):
    ...
    for normiecharacter in string:
        if normiecharacter in normiefont:
            medicharacter = medifont[normiefont.index(normiecharacter)]
            string = string.replace(normiecharacter, medicharacter)
...
MEDI_HANDLER = DisableAbleCommandHandler("medi", medi)
...
dispatcher.add_handler(MEDI_HANDLER)
